...
@section('title', 'Products - Data Scraper')
    ...
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex gap-2">
                <!-- <a href="{{ route('admin.export', ['module' => 'products', 'format' => 'xlsx'] + request()->query()) }}"
                   class="btn btn-success">
                    <i class="fas fa-file-excel"></i> Export Excel
                </a>

                <a href="{{ route('admin.export', ['module' => 'products', 'format' => 'csv'] + request()->query()) }}"
