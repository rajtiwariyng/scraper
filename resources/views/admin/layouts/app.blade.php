...
<head>
    ...
    <title>@yield('title', 'Aethyrtech - Dashboard')</title>
    <!-- Bootstrap CSS -->
...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="navbar-nav ms-auto">
                    <form method="POST" action="{{ route('admin.logout') }}">
                        @csrf
                        <button type="submit" class="btn btn-link nav-link text-left" style="display:inline; padding:0;">
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content">
                <div class="modal-body pt-4 pb-2 text-center">
                    ...
                    <p class="mb-0 fw-semibold" id="confirmModalMessage">Are you sure?</p>
                </div>
    ...
    <script>
        ...
        function showConfirm(message, onConfirm, okLabel = 'Confirm', okClass = 'btn-primary') {
            document.getElementById('confirmModalMessage').textContent = message;
            const okBtn = document.getElementById('confirmModalOk');
            okBtn.className = 'btn btn-sm ' + okClass;
            okBtn.textContent = okLabel;
            const modal = new bootstrap.Modal(document.getElementById('confirmModal'));
            const handler = () => { modal.hide(); onConfirm(); okBtn.removeEventListener('click', handler); };
        ...
        function showToast(message, type = 'success') {
            ...
            const html = `
                <div id="${id}" class="toast align-items-center text-white ${colors[type] || colors.info} border-0" role="alert" aria-live="assertive" aria-atomic="true">
                    <div class="d-flex">
