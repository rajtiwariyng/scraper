...
return [
    ...
    */
    ...
    'platforms' => [
        'amazon' => [
            ...
            'laptop_urls' => [
                'https://www.amazon.in/s?k=laptop&rh=n%3A1375424031',
            ]
        ],
        'flipkart' => [
            'name' => 'Flipkart',
    ...
    */
    ...
    'schedule' => [
        ...
        'max_execution_time' => env('SCRAPER_MAX_EXECUTION_TIME', 28800), // 8 hours
    ],
    ...
    */
    ...
    'validation' => [
        'required_fields' => ['sku', 'product_name', 'platform'],
        'max_description_length' => 5000,
        'max_product_name_length' => 500,
        'max_brand_length' => 100,
        'max_model_length' => 200,
        'price_range' => [
            'min' => 10000,  // Minimum laptop price in INR
            'max' => 1000000  // Maximum laptop price in INR
        ]
    ],
